...
import 'package:mykanji/data/models/resetPasswordApi/post_reset_password_api_req.dart';
...
class ResetpasswordScreen extends GetWidget<ResetpasswordController> {
  ...
  Future<void> onTapResetPasswordButton() async {
    if (_formKey.currentState!.validate()) {
      PostResetPasswordApiReq postResetPasswordApiReq = PostResetPasswordApiReq(
        userName: controller.passwordController.text,
  ...
  /// The dialog box contains a title and a message with the `Reset`
  void _onResetError() {
    Get.defaultDialog(
        onConfirm: () => Get.back(), title: "Failed", middleText: "Reset");
  }
}
