                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildScreenTitle(
                          screenTitle: "Shopping Category - Container".tr,
                          onTapScreenTitle: () => onTapScreenTitle(
                              AppRoutes.shoppingCategoryContainerScreen),
                        ),
                        _buildScreenTitle(
                          screenTitle: "List Product".tr,
                          onTapScreenTitle: () =>
                              onTapScreenTitle(AppRoutes.listProductScreen),
                        ),
                      ],
                    ),
                  ),
